...
public class FollowCam : MonoBehaviour {
	...
	void Update(){
		...
		if (mega_man_pos.x < 69.11 && mega_man_pos.y >= -2.9){
		...
		if (mega_man_pos.x < 75 && mega_man_pos.x >= 69.11 && mega_man_pos.y >= -2.9 && mega_man_pos.y < 8) return;
		...
		if (mega_man_pos.x >= 65 && mega_man_pos.x < 69.35 && mega_man_pos.y < -15 && mega_man_pos.x < 130.5) {
			Vector3 temp = transform.position;
			temp.x = 69.354f;
			temp.y = -14.98015f;
			transform.position = temp;
		...
		if (mega_man_pos.x > 134 && mega_man_pos.x < 136.4 && transform.position.x < 138.44) {
			Vector3 temp = transform.position;
			temp.x += 8f * Time.deltaTime;
			transform.position = temp;
		}
		if (mega_man_pos.x > 136.5 && mega_man_pos.x < 141.5) {
			Vector3 temp = transform.position;
			temp.x = 138.54f;
			temp.y = -14.98015f;
			transform.position = temp;
		}
		if (mega_man_pos.x > 142.1 && transform.position.x < 145.88) {
			Vector3 temp = transform.position;
			temp.x += 8f * Time.deltaTime;
			transform.position = temp;
		}
